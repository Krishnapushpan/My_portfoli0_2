...
import cvPdf from '../assets/KRISHNA_PUSHPAN.pdf';
...
const About = () => (
  <section className="max-w-7xl mx-auto px-2 py-20 flex flex-col md:flex-row items-center gap-6">
    ...
    <div className="flex-1">
      ...
      <a href={cvPdf} download className="bg-gray-900 text-white px-6 py-3 rounded-lg font-semibold shadow hover:bg-gray-800 transition inline-block">Download CV</a>
    </div>
    {/* Image */}
